    ...
    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-md p-5 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-extrabold mt-1"><?php echo e(number_format($todayStats['total'])); ?></h3>
                <p class="text-blue-200 text-xs mt-1"><?php echo e(\Carbon\Carbon::parse($today)->format('M d, Y')); ?></p>
            </div>
    ...
    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-md p-5 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-extrabold mt-1"><?php echo e(number_format($todayStats['passed'])); ?></h3>
                <?php $todayComp = $todayStats['passed'] + $todayStats['failed']; ?>
                <p class="text-green-200 text-xs mt-1">
                    <?php echo e($todayComp > 0 ? round($todayStats['passed'] / $todayComp * 100, 1) : 0); ?>% pass rate
                </p>
            </div>
            <div class="bg-white bg-opacity-20 rounded-full p-3">
    ...
    <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-md p-5 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-extrabold mt-1"><?php echo e(number_format($todayStats['failed'])); ?></h3>
                <p class="text-red-200 text-xs mt-1">
                    <?php echo e($todayComp > 0 ? round($todayStats['failed'] / $todayComp * 100, 1) : 0); ?>% fail rate
                </p>
            </div>
            <div class="bg-white bg-opacity-20 rounded-full p-3">
    ...
    <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-md p-5 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-extrabold mt-1"><?php echo e(number_format($monthStats['total'])); ?></h3>
                <p class="text-purple-200 text-xs mt-1"><?php echo e($monthStats['pass_rate']); ?>% pass rate</p>
            </div>
            <div class="bg-white bg-opacity-20 rounded-full p-3">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-8">
    <div class="flex items-center justify-between mb-3">
        ...
        <span class="text-xs text-gray-400"><?php echo e(number_format($monthStats['passed'])); ?> passed &nbsp;·&nbsp; <?php echo e(number_format($monthStats['failed'])); ?> failed &nbsp;·&nbsp; <?php echo e(number_format($monthStats['total'] - $monthStats['passed'] - $monthStats['failed'])); ?> pending</span>
    </div>
    <div class="w-full bg-gray-100 rounded-full h-4 overflow-hidden flex">
        ...
        ?>
        <div class="bg-green-500 h-4 transition-all duration-500" style="width: <?php echo e($pct); ?>%" title="Passed: <?php echo e($pct); ?>%"></div>
        <div class="bg-red-400 h-4 transition-all duration-500" style="width: <?php echo e($fPct); ?>%" title="Failed: <?php echo e($fPct); ?>%"></div>
        <div class="bg-gray-300 h-4 flex-1" title="Pending"></div>
    </div>
    <div class="flex gap-4 mt-2">
        <span class="flex items-center text-xs text-gray-500"><span class="inline-block w-3 h-3 rounded-full bg-green-500 mr-1"></span>Passed (<?php echo e($pct); ?>%)</span>
        <span class="flex items-center text-xs text-gray-500"><span class="inline-block w-3 h-3 rounded-full bg-red-400 mr-1"></span>Failed (<?php echo e($fPct); ?>%)</span>
        ...
        <div class="p-6">
            ...
            <div class="mt-5 flex items-center justify-between">
                <span class="text-xs text-gray-400">
                    <i class="fas fa-clock mr-1"></i>Today: <?php echo e(number_format($todayStats['total'])); ?> inspections
                </span>
    ...
    <a href="<?php echo e(route('reports.monthly')); ?>"
       class="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 hover:border-green-300 transition-all duration-300 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="mt-5 flex items-center justify-between">
                <span class="text-xs text-gray-400">
                    <i class="fas fa-chart-line mr-1"></i>This month: <?php echo e(number_format($monthStats['total'])); ?> inspections
                </span>
    ...
    <a href="<?php echo e(route('reports.department')); ?>"
       class="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 hover:border-purple-300 transition-all duration-300 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="mt-5 flex items-center justify-between">
                <span class="text-xs text-gray-400">
                    <i class="fas fa-building mr-1"></i><?php echo e($deptCount); ?> active departments
                </span>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    ...
    <a href="<?php echo e(route('reports.daily', ['format' => 'pdf', 'date' => $today])); ?>"
    ...
    <a href="<?php echo e(route('reports.export', ['type' => 'inspections'])); ?>"
    ...
    <a href="<?php echo e(route('reports.export', ['type' => 'vehicles'])); ?>"
       class="group flex items-center gap-4 bg-white rounded-xl shadow-sm border border-gray-100 hover:border-green-200 hover:shadow-md p-4 transition-all duration-200">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\talk2\OneDrive\Desktop\inspection\resources\views/reports/index.blade.php ENDPATH**/ ?>