...
<div x-data="vehiclesPage()">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('vehicles.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition duration-150 ease-in-out">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-1"><?php echo e(number_format($vehicles->total())); ?></h3>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-1"><?php echo e($vehicleTypes->count()); ?></h3>
                </div>
                <div class="bg-white bg-opacity-20 rounded-full p-3">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-1"><?php echo e($vehicles->count()); ?></h3>
                </div>
                <div class="bg-white bg-opacity-20 rounded-full p-3">
    ...
    <div class="bg-white rounded-lg shadow-md mb-6">
        <div class="border-b border-gray-200 px-6 py-4">
            <button @click="showFilters = !showFilters" class="flex items-center justify-between w-full text-left">
                <div class="flex items-center gap-3">
                    ...
                    <?php if(request()->anyFilled(['plate_no','owner','chassis_no'])): ?>
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-700">
                        <?php echo e(collect(['plate_no','owner','chassis_no'])->filter(fn($k) => request()->filled($k))->count()); ?> active
                    </span>
                    <?php endif; ?>
                </div>
        ...
        <div x-show="showFilters" x-collapse class="px-6 py-4">
            <form method="GET" action="<?php echo e(route('vehicles.index')); ?>">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="owner"
                               ...
                               value="<?php echo e(request('owner')); ?>">
                    </div>
                ...
                <div class="flex items-center gap-3 mt-4 pt-4 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('vehicles.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg transition duration-150">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-600">
                    Showing <?php echo e($vehicles->firstItem() ?? 0); ?> to <?php echo e($vehicles->lastItem() ?? 0); ?> of <?php echo e(number_format($vehicles->total())); ?> results
                </span>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-bold text-gray-900"><?php echo e($vehicle->plateno); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($vehicle->licencetype ?? 'N/A'); ?> License</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-semibold text-gray-900"><?php echo e($vehicle->makeofvehicle ?? 'N/A'); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($vehicle->model ?? 'Model N/A'); ?></div>
                                <div class="text-xs text-gray-400 mt-1">
                                    <i class="fas fa-weight text-gray-400 mr-1"></i>
                                    <?php echo e($vehicle->netweight ? number_format($vehicle->netweight) . ' kg' : 'N/A'); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium"><?php echo e(Str::limit($vehicle->owner, 30)); ?></div>
                                <?php if($vehicle->phoneno): ?>
                                <div class="text-xs text-gray-500 mt-1">
                                    <i class="fas fa-phone text-gray-400 mr-1"></i>
                                    <?php echo e($vehicle->phoneno); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-xs text-gray-600">
                                    <div class="mb-1">
                                        <span class="font-medium">Engine:</span> <?php echo e($vehicle->engineno ?? 'N/A'); ?>

                                    </div>
                                    <div>
                                        <span class="font-medium">Chassis:</span> <?php echo e($vehicle->chassisno ?? 'N/A'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php if($vehicle->fueltype): ?>
                                <div class="mt-2">
                                    <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-gray-100 text-gray-700">
                                        <?php if($vehicle->fueltype == 'P'): ?>
                                            <i class="fas fa-gas-pump mr-1"></i> Petrol
                                        <?php elseif($vehicle->fueltype == 'D'): ?>
                                            <i class="fas fa-oil-can mr-1"></i> Diesel
                                        <?php elseif($vehicle->fueltype == 'E'): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php echo e($vehicle->dept_name ?? 'N/A'); ?>

                                </div>
                                <?php if($vehicle->createDate): ?>
                                <div class="text-xs text-gray-500 mt-1">
                                    Added: <?php echo e(\Carbon\Carbon::parse($vehicle->createDate)->format('M d, Y')); ?>
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <a href="<?php echo e(route('vehicles.create')); ?>" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-150">
                                        <i class="fas fa-plus mr-2"></i>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\talk2\OneDrive\Desktop\inspection\resources\views/vehicles/index.blade.php ENDPATH**/ ?>