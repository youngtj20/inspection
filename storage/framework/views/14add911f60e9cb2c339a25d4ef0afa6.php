...
<?php $__env->startSection('title', 'Inspection History — <?php echo e($vehicle->plateno); ?>'); ?>
        ...
        <div class="flex items-center gap-3 mb-1">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm mt-0.5">
                    ...
                    <?php if($vehicle->makeofvehicle): ?> · <?php echo e($vehicle->makeofvehicle); ?> <?php endif; ?>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        ...
        <p class="text-3xl font-extrabold text-gray-800 mt-1"><?php echo e(number_format($total)); ?></p>
        <?php if($firstDate && $lastDate && $firstDate !== $lastDate): ?>
        <p class="text-xs text-gray-400 mt-1">
            <?php echo e(\Carbon\Carbon::parse($firstDate)->format('M Y')); ?> –
            <?php echo e(\Carbon\Carbon::parse($lastDate)->format('M Y')); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        ...
        <p class="text-3xl font-extrabold text-green-600 mt-1"><?php echo e(number_format($passed)); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        ...
        <p class="text-3xl font-extrabold text-red-500 mt-1"><?php echo e(number_format($failed)); ?></p>
        <?php if($failed > 0 && $total > 0): ?>
        <p class="text-xs text-gray-400 mt-1"><?php echo e(round($failed / $total * 100, 1)); ?>% of total</p>
        <?php endif; ?>
    </div>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <p class="text-xs font-semibold text-purple-600 uppercase tracking-wider">Pass Rate</p>
        <p class="text-3xl font-extrabold text-purple-600 mt-1"><?php echo e($passRate); ?>%</p>
        <?php if($pending > 0): ?>
        <p class="text-xs text-gray-400 mt-1"><?php echo e($pending); ?> pending</p>
        <?php endif; ?>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
    <div class="flex items-center justify-between mb-2">
        ...
        <span class="text-xs text-gray-400">
            <?php echo e(number_format($passed)); ?> passed &nbsp;·&nbsp;
            <?php echo e(number_format($failed)); ?> failed
            <?php if($pending > 0): ?> &nbsp;·&nbsp; <?php echo e(number_format($pending)); ?> pending <?php endif; ?>
        </span>
    </div>
    <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden flex">
        ...
        ?>
        <div class="bg-green-500 h-3 transition-all duration-500" style="width:<?php echo e($pPct); ?>%" title="Passed <?php echo e($pPct); ?>%"></div>
        <div class="bg-red-400 h-3 transition-all duration-500" style="width:<?php echo e($fPct); ?>%" title="Failed <?php echo e($fPct); ?>%"></div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        <h2 class="font-semibold text-gray-800 flex items-center gap-2">
            ...
            All Inspections
            <span class="ml-1 text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full font-normal"><?php echo e($total); ?></span>
        </h2>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__currentLoopData = $inspections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <tr class="hover:bg-gray-50 transition-colors group <?php echo e($isPassed ? '' : ($isFailed ? 'bg-red-50/30' : '')); ?>">
                    
                    <td class="px-5 py-3.5 text-gray-400 font-mono text-xs"><?php echo e($i + 1); ?></td>

                    
                    <td class="px-5 py-3.5 whitespace-nowrap">
                        <?php if($inspDate): ?>
                        <div class="font-semibold text-gray-800"><?php echo e($inspDate->format('Y-m-d')); ?></div>
                        <div class="text-xs text-gray-400 mt-0.5"><?php echo e($inspDate->diffForHumans()); ?></div>
                        <?php else: ?>
                    ...
                    <td class="px-5 py-3.5">
                        <span class="font-mono text-xs text-gray-700 bg-gray-100 px-2 py-0.5 rounded">
                            <?php echo e($ins->seriesno); ?>

                        </span>
                    </td>

                    
                    <td class="px-5 py-3.5 text-gray-600 text-xs max-w-[140px] truncate" title="<?php echo e($ins->department_name ?? ''); ?>">
                        <?php echo e($ins->department_name ?? '—'); ?>

                    </td>

                    
                    <td class="px-5 py-3.5">
                        <div class="text-gray-700"><?php echo e($ins->inspector ?? '—'); ?></div>
                        <?php if($ins->workerline): ?>
                        <div class="text-xs text-gray-400 mt-0.5">Line: <?php echo e($ins->workerline); ?></div>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="px-5 py-3.5 text-center">
                        ...
                        <?php if($t > 1): ?>
                        <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-orange-100 text-orange-700 text-xs font-bold" title="<?php echo e($t); ?> inspection(s)">
                            <?php echo e($t); ?>
                    ...
                    <td class="px-5 py-3.5">
                        <span class="text-xs text-gray-500"><?php echo e($typeLabel); ?></span>
                    </td>
    ...
    <div class="px-6 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
        <span><?php echo e($total); ?> record(s) — sorted by most recent first</span>
        <?php if($lastDate): ?>
        <span>Latest: <?php echo e(\Carbon\Carbon::parse($lastDate)->format('M d, Y')); ?></span>
        <?php endif; ?>
    </div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\talk2\OneDrive\Desktop\inspection\resources\views/vehicles/history.blade.php ENDPATH**/ ?>