...
<head>
    <meta charset="utf-8">
    <title>Monthly Inspection Details - <?php echo e(\Carbon\Carbon::parse($month)->format('F Y')); ?></title>
    <style>
        /* Modern CSS Reset */
        * {
            margin: 0;
...
<body>
    <div class="header">
        ...
        <p><strong>🏢 Department:</strong> <?php echo e($departmentName); ?></p>
        <p><strong>🕒 Generated:</strong> <?php echo e(\Carbon\Carbon::now()->format('Y-m-d H:i:s')); ?></p>
                ...
                <td>
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <span style="font-size: 16px; font-weight: bold; color: #1e40af;"><?php echo e(number_format($stats['total'])); ?></span>
                        </div>
                    </div>
                </td>
                <td>
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <span class="passed" style="font-size: 16px; font-weight: bold; padding: 0;"><?php echo e(number_format($stats['passed'])); ?></span>
                        </div>
                    </div>
                </td>
                <td>
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <span class="failed" style="font-size: 16px; font-weight: bold; padding: 0;"><?php echo e(number_format($stats['failed'])); ?></span>
                        </div>
                    </div>
                </td>
                <td>
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <span class="pending" style="font-size: 16px; font-weight: bold; padding: 0;"><?php echo e(number_format($stats['pending'])); ?></span>
                        </div>
                    </div>
                </td>
                <td>
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <span style="font-size: 16px; font-weight: bold; color: #7c3aed;"><?php echo e($stats['pass_rate']); ?>%</span>
                        </div>
                    </div>
                </td>
            </tr>
    ...
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $detailedRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="data-highlight" style="text-align: center;"><?php echo e($record->id); ?></td>
                    <td class="data-highlight"><?php echo e($record->plateno); ?></td>
                    <td style="text-align: center;"><?php echo e($record->vehicletype); ?></td>
                    <td><?php echo e($record->makeofvehicle); ?> <?php echo e($record->model); ?></td>
                    <td class="data-highlight"><?php echo e($record->owner); ?></td>
                    <td><?php echo e($record->phone); ?></td>
                    <td><?php echo e($record->engineno); ?></td>
                    <td><?php echo e($record->chassisno); ?></td>
                    <td style="text-align: center;"><?php echo e(\Carbon\Carbon::parse($record->inspectdate)->format('Y-m-d')); ?></td>
                    <td style="text-align: center;">
                        <?php switch($record->testresult):
                            case ('1'): ?>
                    ...
                    <td><?php echo e($record->inspector); ?></td>
    ...
    <div class="footer">
        <div style="margin-bottom: 15px;">
            ...
            <p>This comprehensive report contains detailed vehicle and inspection information for <strong><?php echo e(number_format($stats['total'])); ?></strong> records.</p>
        </div>
        <div style="border-top: 1px solid #d1d5db; padding-top: 15px; margin-top: 15px;">
            <p style="font-size: 8px; color: #6b7280; line-height: 1.4;">
                ...
                • Page generated on <?php echo e(\Carbon\Carbon::now()->format('Y-m-d H:i:s')); ?><br>
...
<?php /**PATH C:\Users\talk2\OneDrive\Desktop\inspection\resources\views/reports/monthly-details-pdf.blade.php ENDPATH**/ ?>