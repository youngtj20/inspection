...
<head>
    ...
    <title>Inspection Certificate — {{ $inspection->plateno }}</title>
    <style>
...
<div class="page">
    ...
    <div class="cert-header">
        <div class="logo-area">
            ...
            <div class="org-name">
                ...
                @if($inspection->department_name)
                <p>{{ $inspection->department_name }}</p>
                @endif
            </div>
        </div>
        ...
        <div class="cert-no">
            <strong>{{ str_pad($inspection->seriesno ?? $inspection->id, 10, '0', STR_PAD_LEFT) }}</strong>
    ...
    <div class="cert-body">
        ...
        <div class="section">
            ...
            <div class="grid-3">
                <div class="field">
                    ...
                    <div class="value">{{ strtoupper(trim($inspection->plateno ?? '—')) }}</div>
                </div>
                <div class="field">
                    <div class="label">Vehicle Type</div>
                    <div class="value">{{ $inspection->vehicletype ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Licence Type</div>
                    <div class="value">{{ $inspection->licencetype ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Make of Vehicle</div>
                    <div class="value">{{ $inspection->makeofvehicle ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Model</div>
                    <div class="value">{{ $inspection->model ?? '—' }}</div>
                </div>
                <div class="field">
                    ...
                    <div class="value">
                        ...
                        @endphp
                        {{ $fuels[$inspection->fueltype ?? ''] ?? ($inspection->fueltype ?? '—') }}
                    </div>
                </div>
                <div class="field">
                    <div class="label">Engine Number</div>
                    <div class="value">{{ $inspection->engineno ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Chassis Number</div>
                    <div class="value">{{ $inspection->chassisno ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Net Weight (kg)</div>
                    <div class="value">{{ $inspection->netweight ?? '—' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <div class="value">{{ $inspection->owner ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Phone Number</div>
                    <div class="value">{{ $inspection->phoneno ?? '—' }}</div>
                </div>
                <div class="field span-2">
                    <div class="label">Address</div>
                    <div class="value">{{ $inspection->address ?? '—' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="grid-3">
                ...
                <div class="field">
                    ...
                    <div class="value">{{ $inspection->inspecttimes ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Series No</div>
                    <div class="value">{{ $inspection->seriesno ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Inspector</div>
                    <div class="value">{{ $inspection->inspector ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Station / Department</div>
                    <div class="value">{{ $inspection->department_name ?? '—' }}</div>
                </div>
                <div class="field">
                    <div class="label">Result Code</div>
                    <div class="value" style="font-weight:700;color:{{ $passed ? '#15803d' : '#b91c1c' }}">
                        {{ $inspection->testresult }} &mdash; {{ $passed ? 'PASSED' : 'FAILED' }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="conclusion-box">{{ $inspection->conclusion }}</div>
        </div>
        @endif

        {{-- Validity box (PASSED) or Remedial box (FAILED) --}}
        @if($passed)
        ...
        <div class="sig-row">
            <div class="sig-box">
                ...
                <div class="sig-name">{{ $inspection->inspector ?? '' }}</div>
            </div>
            <div class="sig-box">
    ...
    <div class="cert-footer">
        <span>Cert&nbsp;No:&nbsp;{{ str_pad($inspection->seriesno ?? $inspection->id, 10, '0', STR_PAD_LEFT) }}</span>
